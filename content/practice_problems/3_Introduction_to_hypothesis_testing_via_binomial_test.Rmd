...
Null hypothesis: People don't prefer one ear or another.

Alternative hypothesis: People prefer the right ear to their left ear
...
sampling/simulation (code or written explanation)
...
95% confidence interval is 0.562-0.888. Reject null hypothesis because
...
```{r}
binom.test(33,100,0.5,alternative="greater", p=0.25)
```

P value is less than 0.05, so null hypothesis is rejected. The students
did help the dog.
