...
-   What if we know that males actually make up 50.8% of the population?
    ...
    ```{r}
    binom.test(7779, 7779+5065,0.508)
    ```
...
survival does differ based on sex because the null hypothesis is
rejected.
...
Null hypothesis can't be rejected, smoking is independent of exercise.
