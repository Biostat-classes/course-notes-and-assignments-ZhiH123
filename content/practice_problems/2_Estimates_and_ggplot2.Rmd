...
ggplot(sleep, aes(x=BrainWt, y=TotalSleep)) +
  ...
  xlab("BrainWt (g)")+
  ggtitle("Total Sleep Decreases with Brain Weight")
```
...
ggplot(sleep, aes(x=TotalSleep)) +
  geom_histogram() +
  xlab("Total sleep (hours per day)")+
  ggtitle("Variation in Total Time Sleeping")
```
...
95% confidence interval means that 95 out of 100 times the true mean
...
Seems like for all of them, the bigger the sample size, the graph shifts
